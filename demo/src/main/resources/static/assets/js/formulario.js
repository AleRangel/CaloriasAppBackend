...
class InicioSesion  {
    ...
    iniciarSesion(){
        ...
        const respuesta = fetch('/api/auth/iniciarSesion',{
            method: 'POST',
...
class Scraper{
    ...
    buscar(alimentoBuscar, cuantosGramos){
        if (this.loger) {
            fetch(`/api/buscar/${alimentoBuscar}`,{
                method: 'GET',
                headers: {"Content-Type": "application/json",}                
           	...
           	this.notificacion("Necesitas iniciar sesión", "False`");
        }
    };
    ...
    agregarDatosBD(){
        ...
        this.buttonAdd.addEventListener('click',() => {
            ...
            fetch(`/api/usuario/${this.id}/comida`,{
                method: 'POST',
                headers: {'Content-Type': 'application/json',
                  'Authorization': 'Bearer ' + token,
                },body: JSON.stringify({
...
class TablaCalculadora{
    ...
    obtenerDatos(){
        ...
        fetch(`/api/usuario/${this.id}/comidas`,{
            method: 'GET',
            headers: {'Content-Type': 'application/json',
                      'Authorization': 'Bearer ' + token
            }
